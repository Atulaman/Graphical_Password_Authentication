        ...
        <div>
            <div className="flex-col md:flex-row flex justify-around mt-8 sm:mt-16 font-['Work_Sans']">
                ...
                <div className="text-white ml-8 mt-8">
                    ...
                    {/* <button onClick={handleKnowMore} className="transition duration-500 ease-in-out sm:w-1/3 bg-[#000000] rounded-lg px-4 py-1 mt-6 sm:text-xl border-[#000000] border-2 hover:bg-transparent">
                ...
                <div className="hidden sm:block">
                    <img alt="" className=" hover:scale-95 transition duration-500 ease-in-out hover:shadow-2xl hover:shadow-[#000000] rounded-[25px] w-full" src="https://media.istockphoto.com/id/1412282189/photo/lock-network-technology-concept.jpg?s=612x612&w=0&k=20&c=hripuxLs9pS_7Ln6YWQR-Ow2_-BU5RdQ4vOY8s1q1iQ="/>
                </div>
            </div>
