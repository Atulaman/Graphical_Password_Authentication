...
export default function Footer(props) {
    ...
    function handleSubmit() {
        if (validator.isEmail(email)) {
            axios.post(`${BASE_URL}/api/digest`, {email: email})
                .then(() => {
    ...
    return (
        <div className="bg-[#3B3B3B]">
            <div className="bg-[#3B3B3B] mt-24 flex justify-around flex-col sm:flex-row">
                ...
                <div className="ml-4 sm:ml-12 mt-6">
                    <div className="flex">
                        ...
                        <p className="sm:text-xl text-white ml-2 font-['Space_Mono']">GPA System</p>
                    </div>
                    <p className="text-gray-300 font-['Work_Sans'] mt-2 sm:mt-4">A New Way to Authenticate</p>
                </div>
            ...
            <p className="mt-2 text-[#9b9b9b] sm:text-md text-sm text-center pb-4">© Whiteman, G. L. Bajaj</p>
        </div>
